...
class GameScene extends Phaser.Scene {
  constructor() {
    ...
    this.player
    this.cursor
    this.playerSpeed = speedDown - 50 + 1000;
    this.target
    this.points = -1
    this.textScore
    this.textTimer
  ...
  create() {
    ...
    this.player.setOffset(this.player.width / 4, this.player.height / 4);
    ...
    this.textTimer = this.add.text(10, 10, "Remaining Time : 00", {
      font: "25px Arial",
      fill: "#000000",
    });
    ...
    this.emitter.startFollow(this.player, this.player.width / 2, this.player.height / 2, false);
  }
  update() {
    this.remainingTime = this.timedEvent.getRemainingSeconds();
    this.textTimer.setText(`Remaining Time : ${Math.round(this.remainingTime).toString()}`);
